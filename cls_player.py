...
class CLS_Player(object):
    def __init__(self, renderer, lv):
        ...
        self.bltatk, self.bltrad, self.bltdur, self.bltspd = (
            atkList[self.lv][0],
            atkList[self.lv][1],
            atkList[self.lv][2],
            atkList[self.lv][3],
        ...
        self.rect = [
            self.fpos[0] - self.rad // 2,
            self.fpos[1] - self.rad // 2,
            self.rad // 1,
            self.rad // 1,
        ]
    ...
    def move(self):
        ...
        if (
            self.pos[1] + self.speed[1] - self.rad >= 0
            and self.pos[1] + self.speed[1] + self.rad <= GRID_SIZE[1]
        ):
